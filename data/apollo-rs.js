...
export default [
  ...
  {
    "name": "apollo-rs/lexer/err/0002_unterminated_spread_operator_with_2.graphql",
    "error": true,
    "input": ".."
  },
  {
    "name": "apollo-rs/lexer/err/0003_float_with_incorrect_decimal_point.graphql",
    "error": true,
    "input": "456E34.54"
  },
  {
    "name": "apollo-rs/lexer/err/0004_unterminated_string_value.graphql",
    "error": true,
    "input": "\""
  },
  {
    "name": "apollo-rs/lexer/err/0005_escaped_char.graphql",
    "error": true,
    "input": "{\n    sku: \"\\a invalidly escaped\"\n    stringValue: \"\\\"properly escaped\\\"\"\n    name: \"\\invalidly escaped\\\"\"\n}"
  },
  {
    "name": "apollo-rs/lexer/err/0006_unterminated_string_value_in_list_value_argument.graphql",
    "error": true,
    "input": "extend schema\n  @link(url: \"https://specs.apollo.dev/federation/v2.0\",\n        import: [\"@key\", \"@external])\n\ntype Vehicle @key(fields: \"id\") {\n  id: ID!,\n  type: String,\n  modelCode: String,\n  brandName: String,\n  launchDate: String\n}"
  },
  {
    "name": "apollo-rs/lexer/err/0007_unterminated_string_value_in_object_value_argument.graphql",
    "error": true,
    "input": "mutation {\n  createStore(draft: {\n    name: [{ locale: \"en\", value: \"my store }]\n  }) {\n    name(locale: \"en\")\n  }\n}"
  },
  {
    "name": "apollo-rs/lexer/err/0008_unterminated_string_value.graphql",
    "error": true,
    "input": "mutation {\n  createstore {\n    name(locale: \"en)\n  }\n}"
  },
  {
    "name": "apollo-rs/lexer/err/0009_unterminated_string_value_as_default.graphql",
    "error": true,
    "input": "type Person {\n  name: String\n  picture(url: String = \"https://spec.graphql.org/October2021/#DefaultValue): Url\n}"
  },
  {
    "name": "apollo-rs/lexer/err/0010_unterminated_string_value_with_unicode.graphql",
    "error": true,
    "input": "\"hello✨"
  },
  {
    "name": "apollo-rs/lexer/err/0011_unterminated_string_value_with_unicode_and_escaped_characters.graphql",
    "error": true,
    "input": "\"\\n\\n\\\\u{c}\\nPSK\\\\u{1}\\\\0\\\\0\\\\0י"
  },
  {
    "name": "apollo-rs/lexer/err/0012_string_value_with_line_terminators.graphql",
    "error": true,
    "input": "\"\nhello\n\""
  },
  {
    "name": "apollo-rs/lexer/err/0013_string_with_invalid_escapes.graphql",
    "error": true,
    "input": "type Query {\n  \"This is \\\"\\\"a test \\a\\d\\q description\"\n  invalidPlainEscape: String\n  \"\\u008\"\n  incompleteUnicodeEscape: String\n  \"\\uF\"\n  incompleteUnicodeEscape2: String\n  \"\\uzzzz\"\n  invalidUnicodeEscape: String\n  \"\\u123k\"\n  invalidUnicodeEscape2: String\n  \"\\'\"\n  invalidEscapeChar: String\n}\n"
  },
  {
    "name": "apollo-rs/lexer/err/0014_plus_sign.graphql",
    "error": true,
    "input": "+1, +"
  },
  {
    "name": "apollo-rs/lexer/err/0015_minus_sign.graphql",
    "error": true,
    "input": "-1, -"
  },
  {
    "name": "apollo-rs/lexer/err/0016_leading_zero.graphql",
    "error": true,
    "input": "# No error:\n  0   1   42   1.1   0.2   1e04   1e+04   1e-04\n -0  -1  -42  -1.1  -0.2  -1e04  -1e+04  -1e-04\n# Errors:\n 00  01  042  01.1  00.2  01e04  01e+04  01e-04\n-00 -01 -042 -01.1 -00.2 -01e04 -01e+04 -01e-04\n"
  },
  {
    "name": "apollo-rs/lexer/err/0017_number_lookahead.graphql",
    "error": true,
    "input": "# Both IntValue and FloatValue are specified with [lookahead != {Digit, `.`, NameStart}]\n00\n2.\n2.2.\n2.2.2\n2e2.\n2e2.2\n2.2e2.\n2.2e2.2\n2_\n2.2_\n2e2_\n2.2e2_\n2x\n2.2x\n2e2x\n2.2e2x\n2e2e\n2e2e2"
  },
  {
    "name": "apollo-rs/lexer/err/0018_eof_float_1.graphql",
    "error": true,
    "input": "2."
  },
  {
    "name": "apollo-rs/lexer/err/0019_eof_float_2.graphql",
    "error": true,
    "input": "2e"
  },
  {
    "name": "apollo-rs/lexer/err/0020_eof_float_3.graphql",
    "error": true,
    "input": "2e-"
  },
  {
    "name": "apollo-rs/lexer/err/0021_eof_float_4.graphql",
    "error": true,
    "input": "2e+"
  },
  {
    "name": "apollo-rs/lexer/err/0022_eof_string_1.graphql",
    "error": true,
    "input": "\""
  },
  {
    "name": "apollo-rs/lexer/err/0023_eof_string_1.graphql",
    "error": true,
    "input": "\"\\"
  },
  {
    "name": "apollo-rs/lexer/err/0024_eof_string_2.graphql",
    "error": true,
    "input": "\"\\u"
  },
  {
    "name": "apollo-rs/lexer/err/0025_eof_string_3.graphql",
    "error": true,
    "input": "\"\\u222"
  },
  {
    "name": "apollo-rs/lexer/err/0026_eof_block_string_1.graphql",
    "error": true,
    "input": "\"\"\""
  },
  {
    "name": "apollo-rs/lexer/err/0027_eof_block_string_2.graphql",
    "error": true,
    "input": "\"\"\"\\"
  },
  {
    "name": "apollo-rs/lexer/err/0029_not_whitespace.graphql",
    "error": true,
    "input": "﻿# U+FEFF\n\u000b# U+000B\n\f# U+000C\n# U+0085\n # U+00A0\n‎# U+200E\n‏# U+200F\n # U+2028\n # U+2029\n"
  },
  {
    "name": "apollo-rs/lexer/err/0030_escaped_surrogate.graphql",
    "error": true,
    "input": "# TODO: move these cases back to ok/0004_string_value.graphql when\n# https://github.com/apollographql/apollo-rs/issues/657 is implemented\n\"string with unicode surrogate pair escape \\uD83D\\uDE00\"\n\"string with minimal surrogate pair escape \\uD800\\uDC00\"\n\"string with maximal surrogate pair escape \\uDBFF\\uDFFF\"\n\n# TODO: emit two errors: https://github.com/apollographql/apollo-rs/issues/319\n\"split pair \\uD83D \\uDE00\"\n\n\"Backwards pair \\uDE00\\uD83D\"\n\"Lone lead surrogate \\uD83E\"\n\"Lone trail surrogate \\uDD80\"\n"
  },
  {
    "name": "apollo-rs/lexer/ok/0001_hello.graphql",
    "error": false,
    "input": "hello world"
  },
  {
    "name": "apollo-rs/lexer/ok/0002_whitespace.graphql",
    "error": false,
    "input": "a b  c\nd\r\n\re\tf\n"
  },
  {
    "name": "apollo-rs/lexer/ok/0003_name.graphql",
    "error": false,
    "input": "name_ _name __ n0me nam n"
  },
  {
    "name": "apollo-rs/lexer/ok/0004_string_value.graphql",
    "error": false,
    "input": "\"\"\n\"simple\"\n\" white space \"\n\"unicode \\u1234\\u5678\\u90AB\\uCDEF\"\n\"string with \\\"escaped\\\" characters\"\n\"string with multiple languages котя, 猫, ねこ, قطة\"\n\"\"\"\nblock string with unusual whitespaces\na b  c\nd\n\ne\tf\ng  h\ni\u000bj\fk﻿l‎‏m\n\"\"\"\n"
  },
  {
    "name": "apollo-rs/lexer/ok/0005_int.graphql",
    "error": false,
    "input": "-4"
  },
  {
    "name": "apollo-rs/lexer/ok/0006_float.graphql",
    "error": false,
    "input": "4.123\n-4.123\n0.123\n123e4\n123E4\n123e-4\n123e+4\n-1.123e4\n-1.123E4\n-1.123e-4\n-1.123e+4\n-1.123e4567"
  },
  {
    "name": "apollo-rs/lexer/ok/0007_symbols.graphql",
    "error": false,
    "input": "! $ & ... , : = @ ( ) [ ] { } |"
  },
  {
    "name": "apollo-rs/lexer/ok/0008_block_string.graphql",
    "error": false,
    "input": "\"\"\"\nInput Filter with title fitlering\n\"\"\"\ninput Filter {\n  \"\"\"unicode in block string 🤷\"\"\"\n    title: String\n}\n\n\"\"\"\n\\\"\"\" a/b \\\"\"\"\n\"\"\"\ninput Filter {\n    title: String\n}\n\n\"\"\"\n\\\\\"\"\"\n\"\"\"\nscalar LiteralBackslashThenEscape\n"
  },
  {
    "name": "apollo-rs/lexer/ok/0009_block_string_character_with_loose_quotations.graphql",
    "error": false,
    "input": "\"\"\"\nExample with \"\n\"\"\"\ntype Store {\n  \"\"\"\n  **Example**: \"Saturn5\"\n  \"\"\"\n  name: String @join__field(graph: PRODUCTS)\n  \"\"\"\n  \"Another Example\n  \"\"\"\n  title: String\n}"
  },
  {
    "name": "apollo-rs/lexer/ok/0010_empty_string_value_followed_by_eof.graphql",
    "error": false,
    "input": "\"\""
  },
  {
    "name": "apollo-rs/lexer/ok/0011_escaped_char.graphql",
    "error": false,
    "input": "{ name: \"\\\"my store\\\"\" }\n\ntype Query {\n    name: String\n    format: String = \"Y-m-d\\\\TH:i:sP\" \n}"
  },
  {
    "name": "apollo-rs/lexer/ok/0012_unicode_char.graphql",
    "error": false,
    "input": "{ name: \"\\u006Dy store\\\"\" }\n"
  },
  {
    "name": "apollo-rs/lexer/ok/0013_emoji_char_in_string_value.graphql",
    "error": false,
    "input": "mutation UpdateStuff {\n  stuffUpdate(input: {\n    tags: \"really great 👻 halloween\"\n  }) { stuff { tags } }\n}\n"
  },
  {
